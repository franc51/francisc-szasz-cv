export const projectData = [
  {
    ...
    title: "Carly",
    description:
      "Carly is a prototype for an online platform where romanians can register their car from the confort of their home. Features include user registration, vehicle registration, number plate reservation, ITP/RAR booking",
